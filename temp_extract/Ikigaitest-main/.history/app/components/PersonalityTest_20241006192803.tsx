...
const PersonalityTest = () => {
  ...
  return (
    <div className="min-h-screen bg-blue-900 flex flex-col items-center justify-center overflow-hidden relative p-4">
      {stars.map((star) => (
      ...
      <div className="bg-blue-800 bg-opacity-60 backdrop-blur-md rounded-lg p-10 w-full max-w-2xl z-10 shadow-lg border border-blue-600"> {/* Increased padding for better spacing */}
        <h1 className="text-4xl font-bold text-center text-blue-100 mb-8 font-serif font-akwe"> {/* Increased font size for better readability */}
        ...
        <div className="grid grid-cols-2 gap-4">
          {questions[currentQuestion]?.options.map((option, index) => (
            <button
              key={index}
              className="bg-blue-600 hover:bg-blue-700 active:bg-blue-800 focus:bg-blue-800 text-blue-100 font-medium py-3 px-5 rounded-lg transition duration-200 ease-in-out transform hover:scale-105" // Increased padding for buttons
