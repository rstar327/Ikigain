      ...
      <div className="bg-blue-800 bg-opacity-60 backdrop-blur-md rounded-lg p-8 w-full max-w-2xl z-10 shadow-lg border border-blue-600"> {/* Added shadow and border for better contrast */}
        ...
        <div className="grid grid-cols-2 gap-4">
          {questions[currentQuestion]?.options.map((option, index) => (
            <button
              key={index}
              className="bg-blue-600 hover:bg-blue-700 active:bg-blue-800 focus:bg-blue-800 text-blue-100 font-medium py-2 px-4 rounded-lg transition duration-50 ease-in-out transform hover:scale-105" // Changed duration to 200ms for quicker focus animation
