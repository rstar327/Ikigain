...
const PersonalityTest = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center overflow-hidden relative">
      ...
      <div className="relative z-10 w-full max-w-2xl px-4 sm:px-0 flex justify-center">
        <div className="bg-blue-800 bg-opacity-60 backdrop-blur-md rounded-lg p-4 sm:p-8 w-full shadow-lg border border-blue-600">
