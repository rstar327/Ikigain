...
const PersonalityTest = () => {
  ...
  return (
    <div className="min-h-screen bg-blue-900 flex flex-col items-center justify-center overflow-hidden relative p-4">
      ...
      <div className="bg-blue-800 bg-opacity-60 backdrop-blur-md rounded-lg p-6 w-full max-w-md z-10 shadow-lg border border-blue-600">
        <h1 className="text-3xl font-bold text-center text-blue-100 mb-6 font-serif font-akwe">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {questions[currentQuestion]?.options.map((option, index) => (
            <button
              key={index}
              className="bg-blue-600 hover:bg-blue-700 active:bg-blue-800 focus:bg-blue-800 text-blue-100 font-medium py-3 px-4 rounded-lg transition duration-200 ease-in-out transform hover:scale-105"
        ...
        <button
          ...
          className="w-full mt-6 bg-blue-500 text-white py-2 px-4 rounded-lg transition duration-300 hover:bg-blue-600"
        >
