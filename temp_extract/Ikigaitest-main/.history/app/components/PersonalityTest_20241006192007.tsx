...
const PersonalityTest = () => {
  ...
  return (
    <div className="min-h-screen bg-blue-900 flex flex-col items-center justify-center overflow-hidden relative">
      ...
      <div className="bg-blue-800 bg-opacity-70 backdrop-blur-md rounded-lg p-8 w-full max-w-2xl z-10"> {/* Increased bg-opacity for a lighter background */}
        ...
        <div className="grid grid-cols-2 gap-4">
          {questions[currentQuestion]?.options.map((option, index) => (
            <button
              key={index}
              className="bg-blue-600 hover:bg-blue-700 text-blue-100 font-medium py-2 px-4 rounded-lg transition duration-300 ease-in-out transform hover:scale-105" // Animation restored
