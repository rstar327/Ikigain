    ...
    <div className="min-h-screen bg-gray-100 p-8">
      ...
      >
        <div className="p-6 space-y-6">
          {/* Removed the headings */}
          {/* <div className="flex justify-between items-start">
            <div>
              <h1 className="text-6xl font-bold text-blue-900 tracking-wide font-sans">Your Results</h1>
              <p className="text-blue-600 mt-2">Ikigai Analysis</p>
            </div>
          </div> */}
