      ...
      >
        <div className="p-6 space-y-6">
          <div className="flex justify-between items-start">
            <div>
              <h1 className="text-4xl font-semibold text-blue-800 tracking-wide font-sans">Results Overview</h1>
              <p className="text-blue-500 mt-1 text-lg">A Glimpse into Your Ikigai</p>
            </div>
          </div>
