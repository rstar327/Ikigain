...
export default function AdminEmailsLive() {
  ...
  const fetchEmails = async () => {
    try {
      console.log('Fetching emails from /api/collected-emails');
      ...
      if (Array.isArray(data)) {
        console.log('Setting emails:', data.length, 'items');
        setEmails(data);
        setDebugInfo(`✅ Successfully loaded ${data.length} emails`);
      } else {
        console.error('Invalid data format:', data);
        setError('Invalid data format received');
        setDebugInfo(`❌ Invalid data format: ${typeof data}`);
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded mb-6">
          <strong>Debug Info:</strong> {debugInfo || 'Loading...'}
        </div>
